 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.ReceiveMsgRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getUser();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.ReceiveMsgRequest} The clone.
 */
proto.ReceiveMsgRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.ReceiveMsgRequest} */ (jspb.Message.cloneMessage(this));
};
